...
class TelIono:
    ...
    def ionosphere(self, baseline, s0=7.0, wavelength=3.0):
        """ Mevius model
        """
    ...
    def varphase(self, J=1, r0=44.0, B=51.4, wavelength=3.0):
        ...
        """
        return 0.2994 * numpy.power(J, -numpy.sqrt(3)/2.0) * numpy.power(B/(r0*(3.0/wavelength)), 1.8)
    ...
    def tsky(self, J, DR=1e5, r0=44.0, B=51.4, tiono=10.0, wavelength=3.0):
        ...
        """
        return tiono * (DR/1.304)**2 * numpy.power(J, -numpy.sqrt(3)/2.0) * numpy.power(B/(r0*(3.0/wavelength)), 1.8)
